...
# Configure RITS API key if available
if os.getenv("RITS_API_KEY"):
    # Set the RITS API key for litellm
    os.environ["RITS_API_KEY"] = os.getenv("RITS_API_KEY")
    # Also set as a generic API key that litellm can use
    if not os.getenv("OPENAI_API_KEY"):
        os.environ["OPENAI_API_KEY"] = os.getenv("RITS_API_KEY")

litellm.drop_params = True
# Enable verbose logging for debugging (optional, can be disabled in production)
...
def llm_completion(model, prompt, chat_history=None, return_finish_reason=False):
    ...
    # RITS models need specific API base and headers
